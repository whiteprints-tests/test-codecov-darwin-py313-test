...
BOM-licenses:
    ...
    @just reuse " \
        spdx \
        --creator-organization 'Romain Brault <mail@romainbrault.com>' \
...
translation-extract:
    @just pybabel " \
        extract \
            --omit-header \
            --sort-by-file \
            --output 'src/test_codecov_darwin_py313_test/locale/base.pot' \
            src \
    "
...
translation-init locale:
    @just pybabel " \
        init \
            --input-file 'src/test_codecov_darwin_py313_test/locale/base.pot' \
            --output-dir 'src/test_codecov_darwin_py313_test/locale' \
            --locale='{{ locale }}' \
    "
